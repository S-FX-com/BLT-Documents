...
<div class="wrap blt-documents-wrap">
	<h1>
		...
		printf(
			...
			esc_html__( 'Version History — %s', 'blt-documents' ),
			esc_html( $file->title )
		);
		?>
	</h1>
	...
	<p class="description">
		<?php esc_html_e( 'Every uploaded version is retained. Prior versions are only reachable here — never publicly, and never by search engines.', 'blt-documents' ); ?>
	</p>
	...
	<table class="wp-list-table widefat fixed striped">
		...
		<tbody>
			<?php if ( empty( $versions ) ) : ?>
				<tr><td colspan="7"><?php esc_html_e( 'No versions recorded.', 'blt-documents' ); ?></td></tr>
			<?php endif; ?>
			<?php
				...
				<tr>
					<td>
						...
						<?php if ( $blt_is_current ) : ?>
							<span class="blt-doc-current-tag"><?php esc_html_e( '(current)', 'blt-documents' ); ?></span>
						<?php endif; ?>
					</td>
